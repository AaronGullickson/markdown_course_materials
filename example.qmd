...
shorttitle: "Example Doc"
shortauthors: "Gullickson & Secondauthor"
author:
...
format: 
  html:
    ...
    #mainfont: MarkerFelt-Wide # font for text
  ...
  #  sansfont: Futura-Medium     # font for headings
  #  include-in-header: 
  #    text: |
  #      \usepackage{booktabs}
  #      \usepackage{dcolumn}
  ...
  pdf:
    ...
    #mainfont: Papyrus   # font for regular text
    #sansfont: ComicSansMS     # font for headings
    #monofont: Osaka-Mono    # font for code
...
Elit varius diam quam magnis suscipit leo aptent congue? Proin placerat ultrices interdum mollis platea integer ac pharetra vulputate lacinia. @tbl-penguins viverra nostra bibendum lacus lobortis varius condimentum eleifend faucibus odio justo montes sagittis? Eget imperdiet class tellus tincidunt dictumst sem ridiculus quam? Eget rutrum fames ridiculus eget pretium neque libero per! Eget dignissim magna nunc nulla dis orci interdum tellus tortor risus ut.
