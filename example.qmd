...
format: 
  ...
  pdf:
    ...
    keep-md: false
    keep-tex: true
    ## Change to alternate citation system
    cite-method: natbib
    natbiboptions: authoryear,comma # other options are numbers, super
    biblio-title: References
    biblio-style: bib-styles/ajs.bst
    ## To change document characteristics
    ...
    ## Include latex stuff in preamble
    include-in-header: 
      text: |
        \usepackage{dcolumn}
...
Check out my diagram in @fig-mermaid!

```{r}
#| label: fig-mermaid
#| fig-cap: A flowchart made in mermaid
knitr::include_graphics("input/mermaid_diagram.png")
```
