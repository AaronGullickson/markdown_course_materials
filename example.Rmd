...
knitreg(list(model1, model2, model3),
        ...
        custom.note="\\parbox{\\linewidth}{\\vspace{2pt} \\small \\emph{Notes:} Standard errors in parenthesis. Standard errors in parenthesis. Standard errors in parenthesis. Standard errors in parenthesis. Standard errors in parenthesis. Standard errors in parenthesis.}")
```
