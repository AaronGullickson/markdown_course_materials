...
popularity %>% 
  ...
  footnote(general=
             c("Drinking frequently is defined as drinking at least one or twice a month for the previous 12 months.",
               "Smoking frequently is defines as smoking at least 5 cigarettes in the last 30 days."),
...
Lorem accumsan pharetra est cubilia placerat cubilia est fusce natoque laoreet rutrum porta pellentesque tempus! Inceptos arcu augue phasellus nunc ad aptent sem pulvinar maecenas. Tempor porttitor velit fermentum ornare convallis consequat proin mauris. Magna tortor non integer proin semper ad malesuada cras orci. See Figure \@ref(fig:fig-income-nom).
