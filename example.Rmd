...
output:
  ...
  word_document: 
    keep_md: no
  # additional more advanced formats
  ...
  rmdformats::robobook:
    ...
    code_folding: hide
    lightbox: TRUE
# bibliography information for citations
bibliography: references.bib
csl: bib-styles/chicago-parenthetical.csl
# You can also use a link to the CSL rather than a local file
