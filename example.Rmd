...
knitreg(list(model1, model2, model3),
        ...
        #threeparttable=TRUE, # should work for wrapping but produces latex processing error at the moment
        custom.note="%stars. Robust clustered standard errors in parenthesis. Data come from Add Health, Wave 1 respondents.")
```
