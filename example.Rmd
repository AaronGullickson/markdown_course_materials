---
# Basic information on title, author, date, and abstract
...
# The next three entries only work in some output formats
...
# The next five entries can be uncommented to change look for LaTeX/PDF only
#documentclass: scrartcl
#fontfamily: accanthis # See https://tug.org/FontCatalogue/ for full list
#fontsize: 11pt
#geometry: margin=1in
#papersize: letter
# All of the various output options are listed below with further indentation
# for specific output options
output:
  html_document: 
    self_contained: yes
    keep_md: no
  ...
  rmdformats::robobook:
    ...
    code_folding: hide
    lightbox: TRUE
# These last entries control aspects of the bibliography and citation
bibliography: references.bib
csl: bib-styles/chicago-parenthetical.csl
# You can also specify CSL files with a url
