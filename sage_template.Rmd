...
runninghead: Gullickson, Example
author:
- name: Aaron Gullickson
  num: 1
address:
- num: 1
  org: Department of Sociology, University of Oregon
corrauth: "Aaron Gullickson, 727 PLC, University of Oregon, Eugene OR 97403."
...
# Many rticles templates use a LaTeX bst file rather than CSL
bibliographystyle: bib-styles/sageh
output:
  rticles::sage_article:
    keep_tex: no
# This is an alternative way to load LaTeX package dependencies
header-includes: 
 - \usepackage{dcolumn}
 - \usepackage{booktabs}
---
...
knitr::opts_chunk$set(echo = FALSE, warning=FALSE, message = FALSE,
                      fig.pos="t", fig.height=4, fig.width=5, out.extra="")
library(ggplot2)
library(tidyverse)
library(scales)
library(texreg)
...
popularity %>% 
  ...
  footnote(general=
             c("Drinking frequently is defined as drinking at least one or twice a month for the ",
               "previous 12 months. Smoking frequently is defined as smoking at least 5 cigarettes in",
               "the last 30 days."),
